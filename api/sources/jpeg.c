...
static void my_error_exit_nothing(j_common_ptr cinfo)
{
}

static void my_error_exit_int(j_common_ptr cinfo, int i)
{
}

static void my_error_exit_pchar(j_common_ptr cinfo, char *c)
{
}
...
jpeg_decompress(unsigned char *dst, unsigned char *src, int size, int *w, int *h) {
  ...
  mderr.pub.output_message = my_error_exit_nothing;
  mderr.pub.reset_error_mgr = my_error_exit_nothing;
  mderr.pub.emit_message = my_error_exit_int;
  mderr.pub.format_message = my_error_exit_pchar;
