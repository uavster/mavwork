...
typedef Comm::NavigationServer<Comm::DycsServer<Comm::RdcpServer<Comm::UdpSocket, Comm::InetAddress> , Comm::RdcpSocket<Comm::UdpSocket, Comm::InetAddress> > , Mav::CommandData, Mav::StateInfo> Nav1DycsRdcpInetServer_base;
