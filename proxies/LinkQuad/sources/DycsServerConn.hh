...
template_def void DycsServerConn_::getBuffers(cvg_int *readBuffLen, cvg_int *writeBuffLen) {
	socket->getBuffers(readBuffLen, writeBuffLen);
}

template_def void DycsServerConn_::setBuffers(cvg_int readBuffLen, cvg_int writeBuffLen) {
	socket->setBuffers(readBuffLen, writeBuffLen);
}
