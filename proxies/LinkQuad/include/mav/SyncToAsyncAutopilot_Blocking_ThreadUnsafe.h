...
public:
	...
	inline virtual void setFeedbackRate(cvg_double pf) { worker.setStateInfoPeriod(1.0 / pf); }
	...
	inline virtual void notifyLongTimeSinceLastStateInfoUpdate(StateInfo *si) {}
};
